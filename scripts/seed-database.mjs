...
const PROPERTIES = [
  ...
  // ── New Residential Rentals (4) ────────────────────────────────────────────
  {
    _slug: "mabolo-2br-house-rent",
    title: "2BR House for Rent, Mabolo Cebu City",
    description:
      "Cozy 2-bedroom bungalow for rent in quiet Mabolo — minutes from SM City Cebu and Mactan Airport. Covered parking, small garden, and all utilities available. Ideal for small families or couples.",
    price: 25000,
    price_type: "rent",
    price_period: "monthly",
    property_type: "house",
  ...
  {
    _slug: "it-park-3br-condo-rent",
    title: "3BR Condo for Rent, Cebu IT Park",
    description:
      "Spacious 3-bedroom condo in the heart of Cebu IT Park. Fully furnished, high floor with sweeping city views, gym, pool, and 24/7 security. Perfect for expat families and senior executives.",
    price: 55000,
    price_type: "rent",
    price_period: "monthly",
    property_type: "condo",
  ...
  {
    _slug: "guadalupe-townhouse-rent",
    title: "3BR Townhouse for Rent, Guadalupe",
    description:
      "Well-maintained 3-bedroom townhouse in a quiet Guadalupe neighbourhood. Open-plan ground floor, covered parking, small rear garden. Close to SRP, schools, and Cebu City centre.",
    price: 28000,
    price_type: "rent",
    price_period: "monthly",
    property_type: "townhouse",
  ...
  {
    _slug: "banilad-furnished-house-rent",
    title: "4BR Furnished House for Rent, Banilad",
    description:
      "Premium 4-bedroom furnished house in prestigious Banilad. Three-car garage, landscaped garden with lanai, full appliance package including washer-dryer. Ideal for expat families and senior management.",
    price: 65000,
    price_type: "rent",
    price_period: "monthly",
    property_type: "house",
